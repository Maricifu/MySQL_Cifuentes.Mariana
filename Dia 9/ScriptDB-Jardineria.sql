...
/* Se desea crear una base de datos para una jardinería y hacer consultas */

-- crear DB
CREATE DATABASE Jardinerias;
USE Jardinerias;

-- se crea tabla de gama_producto
